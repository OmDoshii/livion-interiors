      ...
      <header className="bg-white border-b border-cream-200 sticky top-0 z-30">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div>
              <span className="font-display text-xl text-charcoal block leading-none">LIVION</span>
              <span className="text-[8px] tracking-[0.25em] uppercase text-charcoal-muted">INTERIORS · CRM</span>
            </div>
          </div>
            ...
            {STATUSES.map((col) => (
              <div key={col.id} className="flex flex-col gap-3">
                ...
                <div className={cn("border-t-2 pt-3 flex items-center justify-between", col.color)}>
                  <p className="text-xs font-body font-400 text-charcoal tracking-wide">{col.label}</p>
              ...
              <thead>
                <tr className="border-b border-cream-200">
                  {["Name", "Phone", "Location", "Flat", "Budget", "Possession", "Status", "Date", "Action"].map((h) => (
                    <th key={h} className="text-left px-4 py-3 text-[10px] tracking-[0.12em] uppercase text-charcoal-muted font-body font-400">
                      {h}
                    </th>
                  ))}
                </tr>
